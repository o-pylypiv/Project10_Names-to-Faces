...
Project10 is an iOS app that allows users to add and view a collection of people with their names and images. Users can also rename or delete a person from the collection.
